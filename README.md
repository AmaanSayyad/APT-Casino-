...
![APT-Casino - Analog pptx](https://github.com/user-attachments/assets/630adbe2-b271-4f47-90d3-aa938f09be5c)
...
![APT-Casino - Analog pptx (2)](https://github.com/user-attachments/assets/aa3683b2-0681-45ea-a0f4-a480ab545fcb)

## Technical Architecture

![captures_chrome-capture-2024-5-22](https://github.com/user-attachments/assets/090e200e-3bc4-44ef-b73e-ebc238cf47dd)
...
![APT-Casino - Analog pptx (3)](https://github.com/user-attachments/assets/ae0ecf01-4692-494d-890f-44f0b91e0aaf)
...
- Analog Watch, GMP SDK, and Timechain, Next.js, Javascript, Tailwind CSS, Move, Solidity, Chainlink VRF, Aptos randomness module: aptos_framework::randomness, Petra Wallet, Metamask Wallet.

## Encryption: Card Security from Generation to Decryption 

![APT-Casino - Analog pptx (4)](https://github.com/user-attachments/assets/9d9cd145-d6d1-487d-aadb-c97a76ead8ad)

## Encryption: Pathways to Improvements 

![APT-Casino - Analog pptx (5)](https://github.com/user-attachments/assets/77396355-e321-4273-86ca-db10bc9c5088)

## Modularization: Examples

![APT-Casino - Analog pptx (7)](https://github.com/user-attachments/assets/bf38a786-acc9-4f24-a078-89d83a211396)
...
![APT-Casino - Analog pptx](https://github.com/user-attachments/assets/6fb21656-3562-4edc-98b5-3ef0599e5828)
